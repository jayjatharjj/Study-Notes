...
|------|-------|-------|-------|
| [01](prep-weeks/week-01.md) | Jun 17–21 *(5-day)* | Foundations | Arrays / Two Pointers / Sliding Window · Java internals (equals/hashCode, HashMap) · resume + deep-dive doc |
| [02](prep-weeks/week-02.md) | Jun 22–28 | Foundations | Hashing / Strings · bit manipulation · Collections deep-dive · system-design primer |
| [03](prep-weeks/week-03.md) | Jun 29–Jul 5 | Foundations | Recursion / Binary Search · Spring core (IoC, beans, @Transactional) · concurrency · LLD primer |
| [04](prep-weeks/week-04.md) | Jul 6–12 | Foundations | Stacks / Queues / LinkedList · REST + OAuth2/JWT · estimation drill · **self-assessment checkpoint** |
| [05](prep-weeks/week-05.md) | Jul 13–19 | Core Build | Trees · caching + indexing + SQL/NoSQL · frontend (Vue 3 / React) · target-company list |
| [06](prep-weeks/week-06.md) | Jul 20–26 | Core Build | Graphs + Trie + Dijkstra · messaging/async, Outbox, Saga · GitHub polish |
| [07](prep-weeks/week-07.md) | Jul 27–Aug 2 | Core Build | DP intro · rate limiting, API gateway, circuit breakers + bulkhead · mock system design |
| [08](prep-weeks/week-08.md) | Aug 3–9 | Core Build | DP + Greedy · cloud/DevOps talking points · **profiles live + warm-up applications** |
| [09](prep-weeks/week-09.md) | Aug 10–16 | Peak | Heaps + design-DS · design at scale (sharding/CAP) · **hard applications to GCCs/product** |
| [10](prep-weeks/week-10.md) | Aug 17–23 | Peak | Company-tagged DSA · **10 STAR stories** · News Feed HLD · more applications + first rounds |
| [11](prep-weeks/week-11.md) | Aug 24–30 | Peak | DSA maintenance · **interviews cluster** · full-stack consolidation + project rehearsal |
| [12](prep-weeks/week-12.md) | Aug 31–Sep 6 | Close | Light DSA · **interview-loop execution** · per-company tailoring + pipeline tracking |
| [13](prep-weeks/week-13.md) | Sep 7–13 | Close | **Negotiation & close** · competing-offer leverage · clean resignation + 60-day notice |
